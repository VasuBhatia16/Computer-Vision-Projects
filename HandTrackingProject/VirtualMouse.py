import cv2
import numpy as np
import HandTrackingMouse as htm
import time
import autopy
import os
...
while True:
    ...
    if len(lmList) != 0:
        ...
        # 11. Both Thumb and pinky are up : Right Clicking mode
        if fingers[1] == 1 and fingers[2] == 1:
